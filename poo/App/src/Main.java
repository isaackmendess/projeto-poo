public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\n--- Questão 03 ---");
        CarroEsportivo meuCarroEsportivo = new CarroEsportivo("Ferrari", "488 GTB", 2023, 330);
        ...
        Carro meuCarroComMotor = new Carro("Chevrolet", "Camaro", 2023);
        meuCarroComMotor.setMotor(motorCarro);
